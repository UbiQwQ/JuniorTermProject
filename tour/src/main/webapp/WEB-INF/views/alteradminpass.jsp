...
<div id="wrapper">
    ...
    <div class="main">
        <form class="form-horizontal" action="/adminalterpass" method="post">
            <div class="input-group col-md-4" style="margin-left:60px;margin-top: 60px;">
                <input type="password" class="form-control" placeholder="旧密码" name="oldpassword" required/>
            </div>
            <div class="input-group col-md-4" style="margin-left:60px;margin-top: 20px;">
                <input type="password" class="form-control" placeholder="新密码" name="newpassword" required/>
            </div>
            <div class="input-group col-md-4" style="margin-left:60px;margin-top: 20px;">
                <input type="password" class="form-control" placeholder="重复密码" name="repassword" required/>
            </div>
            <div class="input-group col-md-4" style="margin-left:60px;margin-top: 20px;width: 100px;">
                <span class="input-group-btn">
                   <button class="btn btn-info btn-search">修改密码</button>
                </span>
            </div>${success}${oldPassErro}${rePassErro}${error}
        </form>
    </div>
</div>
